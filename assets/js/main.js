...
*/
function getBigFirstLetter(text) {
...
function greetByName(msg, name) {
  ...
  msg = getBigFirstLetter(msg);
  name = getBigFirstLetter(name);
  return `${msg}, ${name}`;
}

console.log(greetByName('','Tatiana'));
console.log(greetByName('Hi','Tatiana'));
...
console.log(sumBigIntegers(785478251456236548, 2541258796325412));